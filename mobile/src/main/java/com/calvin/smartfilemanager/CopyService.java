...
public class CopyService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            ContentProviderClientCompat.releaseQuietly(mSrcClient);
            ContentProviderClientCompat.releaseQuietly(mDstClient);
    ...
    private void makeProgress(long bytesCopied) {
        ...
        if (currentTime - mLastNotificationTime > 1000) {
            ...
            if (mRemainingTime > 0) {
                ...
                mProgressBuilder.setContentText("Copying file now ...");
            } else {
     ...
     * @throws RemoteException
     */
    private void copy(DocumentInfo srcInfo, DocumentInfo dstDirInfo) throws Exception {
     ...
     * @throws RemoteException
     */
    private void copyDirectoryHelper(Uri srcDirUri, Uri dstDirUri) throws Exception {
