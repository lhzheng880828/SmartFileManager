...
public class ProviderExecutor extends Thread implements Executor {
    ...
    private static HashMap<String, ProviderExecutor> sExecutors = new HashMap<>();//Maps.newHashMap();
    ...
    private final ArrayList<WeakReference<Preemptable>> mPreemptable = new ArrayList<>();//Lists.newArrayList();
