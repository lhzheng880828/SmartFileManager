...
import com.calvin.smartfilemanager.provider.DocumentsProvider;
import com.calvin.smartfilemanager.provider.UsbStorageProvider;
...
import com.calvin.smartfilemanager.misc.ImageUtils;
import com.calvin.smartfilemanager.misc.OsCompat;
...
import static com.calvin.smartfilemanager.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "com.calvin.smartfilemanager.action.DOCUMENTS_PROVIDER";
     ...
     * {@link com.calvin.smartfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link com.calvin.smartfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link com.calvin.smartfilemanager.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link com.calvin.smartfilemanager.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link com.calvin.smartfilemanager.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link com.calvin.smartfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link com.calvin.smartfilemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
