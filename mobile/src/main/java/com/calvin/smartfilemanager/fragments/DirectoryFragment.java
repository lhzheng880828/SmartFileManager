...
import com.calvin.smartfilemanager.CopyService;
import com.calvin.smartfilemanager.loader.DirectoryLoader;
...
import com.calvin.smartfilemanager.misc.IconUtils;
import com.calvin.smartfilemanager.MimePredicate;
import com.calvin.smartfilemanager.ProviderExecutor;
import com.calvin.smartfilemanager.ProviderExecutor.Preemptable;
import com.calvin.smartfilemanager.R;
import com.calvin.smartfilemanager.loader.RecentLoader;
import com.calvin.smartfilemanager.provider.RecentsProvider;
import com.calvin.smartfilemanager.provider.RecentsProvider.StateColumns;
import com.calvin.smartfilemanager.cursor.RootCursorWrapper;
import com.calvin.smartfilemanager.misc.RootsCache;
import com.calvin.smartfilemanager.misc.ThumbnailCache;
...
import static com.calvin.smartfilemanager.BaseActivity.State.ACTION_BROWSE_ALL;
...
import static com.calvin.smartfilemanager.BaseActivity.State.MODE_GRID;
import static com.calvin.smartfilemanager.BaseActivity.State.MODE_LIST;
...
import static com.calvin.smartfilemanager.DocumentsActivity.TAG;
import static com.calvin.smartfilemanager.model.DocumentInfo.getCursorInt;
import static com.calvin.smartfilemanager.model.DocumentInfo.getCursorLong;
...
public class DirectoryFragment extends Fragment {
    ...
    private void onShareDocuments(List<DocumentInfo> docs) {
        ...
        if (docsForSend.size() == 1) {
            ...
            final ArrayList<String> mimeTypes = new ArrayList<>();//Lists.newArrayList();
            final ArrayList<Uri> uris = new ArrayList<>();//Lists.newArrayList();
    ...
    private class DocumentsAdapter extends BaseAdapter {
        ...
        private List<Footer> mFooters = new ArrayList<>();//Lists.newArrayList();
    ...
    private static class ThumbnailAsyncTask extends AsyncTask<Uri, Void, Bitmap>
        ...
        protected Bitmap doInBackground(Uri... params) {
            ...
            try {
                ...
                result = DocumentsContract.getDocumentThumbnails(client, mUri, mThumbSize, mSignal);
                if (result != null) {
                    final ThumbnailCache thumbs = DocumentsApplication.getThumbnailsCache(
                            context, mThumbSize);
