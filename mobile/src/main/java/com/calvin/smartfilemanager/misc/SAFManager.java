...
import com.calvin.smartfilemanager.fragments.DialogFragment;
...
import com.calvin.smartfilemanager.provider.BasicDocumentFile;
...
import com.calvin.smartfilemanager.provider.UsbDocumentFile;
...
import static com.calvin.smartfilemanager.misc.IntentUtils.ACTION_OPEN_DOCUMENT_TREE;
import static com.calvin.smartfilemanager.provider.ExternalStorageProvider.ROOT_ID_SECONDARY;
...
public class SAFManager {
    ...
    public static String getRootUri(Uri uri) {
        if (isTreeUri(uri)) {
            return com.calvin.smartfilemanager.model.DocumentsContract.getTreeDocumentId(uri);
        }
        return com.calvin.smartfilemanager.model.DocumentsContract.getDocumentId(uri);
    }

    private static Uri buildDocumentUriMaybeUsingTree(Uri uri, String docId) {
        return com.calvin.smartfilemanager.model.DocumentsContract.buildDocumentUriMaybeUsingTree(uri, docId);
    }

    private static boolean isTreeUri(Uri uri) {
        return com.calvin.smartfilemanager.model.DocumentsContract.isTreeUri(uri);
    }
